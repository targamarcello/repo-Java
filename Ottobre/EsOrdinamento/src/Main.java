...
public class Main {
    public static void main(String[] args) {
        ...
        String[] opzioni = {"Menù", "1-Genera Random", "2-Visualizzazione", "3-Ricerca","4-Rimuovi","5-Rimuovi Con Copia","6-Ordinamento","7-Raddoppia", "8-Fine"};
        boolean esci = true;
        ...
        do {
            switch (Menu(opzioni, tastiera)) {
                ...
                case 6->{
                    ...
                    Ordinamento(nEstratti,nEstratti2);
                }
                case 7->{
                    System.out.println("Raddoppio Vettore");
                    int[]nuovoVett = RaddoppiaVett(nEstratti);
                    VisualizzaRighe(nuovoVett);
                    System.out.println("Il numero di elementi aggiunti nell'array è: "+(nuovoVett.length-nEstratti.length));
                }
                case 8->{
    ...
    public static void Ordinamento(int[]vett, int[]vett2){
        int dim = vett.length;
    ...
    public static int[] RaddoppiaVett(int[] nEstratti){
        int[]newVett = new int [nEstratti.length];
        for(int i=0; i<nEstratti.length; i++){
            newVett[i] = nEstratti[i];
        }
        return newVett;
    }
}